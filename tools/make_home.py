...
FONTS = ('  <link rel="preconnect" href="https://fonts.googleapis.com" />\n'
         ...
         '  <link rel="stylesheet" href="assets/css/clay.css?v=3" />\n')
  ...
  <section id="lead" class="lead-section">
    <div class="container contacts-grid" id="contacts">
        ...
        <div class="map-clay">
          ...
          <iframe title="Карта: Центр речи «Будущее»" src="https://yandex.ru/map-widget/v1/?um=constructor%3A9996d344e573e19ada8a09769e0805538d61ed77c2111496ba64e6303410f68f&amp;source=constructor" width="640" height="400" loading="lazy" allowfullscreen></iframe>
        </div>
    </div>
  </section>
